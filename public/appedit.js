window.addEventListener('load', () => {
    ...
    const items = (meta) => {
        meta.all.items.forEach((data, i) => {
            ...
            const divQuantity = document.createElement('input');
            divQuantity.type = 'number';
            divQuantity.className = 'itemQuantity';
            const itemQuantity = data.quantity;
            divQuantity.placeholder = data.quantity;
            ...
            const divDiscountValue = document.createElement('input');
            ...
            divDiscountValue.placeholder = itemDiscountValue;
            ...
            if (meta.all.items.length == i) {
                ...
                invoice.total = itemsSumaSuPVM.innerText;

                totalPrice.append(itemsSumaSuPVM);
            }

            const saveBtn = document.querySelector('#updateData');
            saveBtn.addEventListener('click', () => {
                ...
                const discountInputs = document.querySelectorAll('.itemDiscountValue');
                quantityInputs.forEach((input, i) => {
                    const newQty = parseFloat(input.value) || invoice.all.items[i].quantity;
                ...
                discountInputs.forEach((input, i) => {
